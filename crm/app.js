...
window.closeCategoriesDropdown = lazyLoad('./modules/features/companies.js', 'closeCategoriesDropdown');
window.openCategoriesDropdown = lazyLoad('./modules/features/companies.js', 'openCategoriesDropdown');
window.toggleCategoriesDropdown = lazyLoad('./modules/features/companies.js', 'toggleCategoriesDropdown');
...
window.initWorkflowEngine = lazyLoad('./modules/features/workflow-engine.js', 'initWorkflowEngine');
window.stopWorkflowEngine = lazyLoad('./modules/features/workflow-engine.js', 'stopWorkflowEngine');
window.invalidateWorkflowCache = lazyLoad('./modules/features/workflow-engine.js', 'invalidateWorkflowCache');
